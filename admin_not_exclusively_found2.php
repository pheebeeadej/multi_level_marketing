...
// fetching out all tyransaction
  if(isset($_POST['search_submit'])){
        ...
        $fet = mysqli_query($database, "SELECT * FROM mlm_notification WHERE transactionID LIKE '%$key%' OR type LIKE '%$key%' OR amount LIKE '%$key%' OR status LIKE '%$key%' OR transaction_ref LIKE '%$key%'  OR date LIKE '%$key%' ORDER BY id DESC LIMIT 30");
               
    }else{
        
        $fet = mysqli_query($database, "SELECT * FROM mlm_notification ORDER BY id DESC LIMIT 30");
                    ...
                    <div class="col-12 p-0">
                     ...
                     <div class="box p-0">
                        <div class="box-header with-border">
                          <h3 class="box-title">Transaction History</h3><br>
                          <h5>Total transactions: <?php echo mysqli_num_rows(mysqli_query($database, "SELECT * FROM mlm_notification ")); ?></h5>
