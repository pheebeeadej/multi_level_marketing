  ...
  <!--      </div>-->
		...
		<section class="content">
            <div class="row">
                ...
                <!--  </div>-->
                <!--</div>-->
                 <iframe width="560" height="315" src="https://www.youtube.com/embed/PLMNOuwjuNs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="col-12">
                  <div class="box">
                    <div class="box-body">
                        <h5 style="color:blue;font-weight:bold;">WHAT IS MAYOLAD CONNECT?</h5>
                        <p>
                        ...
                        <p>
                            <h2><strong>THREE DIFFERENT WAYS TO EARN ON M-CONNECT</strong></h2><br>
                            ...
                            You will earn #50 direct Referral bonus on each fellow that registers using your referral link, this is unlimited as you can refer as much as you can.<br><br><br>
                             ...
                             Our matrix plan allows you to earn some percentage of your downlines’ registration fee. This does not matter if you are the referral, you will earn once your downlines refer people as well and the downlines of your downlines and you keep earning commission deep down to the 6th generation of your team.<br><br>
                             
                        </p> <center>
                        <p class="text-center" style="text-align:center;">
                             <h2><strong>MATRIX COMPENSATION PLANS</strong></h2><br>
                          <h4>
                                Level 1<br>
                            #90 x 5 = #450<br>
                          </h4>
                           ...
                           <h4>
                            ...
                            <h4>
                                Level 3<br>
                            #76 X 125 = #9500<br>
                            Incentive: Customized T-Shirt and Face cap<br>
                            </h4>
                             <img src='images/3.jpeg' style="height:200px;"><br><br>
                            <h4>
                                Level 4<br>
                            #90 X 625 = #56,250<br>
                            Incentive: Raw food worth #5000<br>
                            </h4>
                        ...
                        <h5 style="color:blue;font-weight:bold;">You still don't understand the matrix plan right?<br>
                        Okay, this is what it means.</h5>
                        <p>
                            1. Once you refer 5 people, you'll earn #90 from each of them and that's total of #450. Your #50 direct Referral bonus on each members you refer will be added to it as well<br>
                            
                            2. When those 5 people refer the 5 people each, you'll earn #76 in 25 places and that's #19,000 + 2 tin of liquid milk.<br>
                            
                            3. When those 25 people refer the 5 people each, you'll earn #76 in 125 places and that's #95,000 + 1 Customized T-Shirt and 1 Face cap.<br>
                            
                            4. When those 125 people refer the 5 people each, you'll earn #90 in 625 places and that's #56,250 + Raw food worth #5000.<br>
                            
                            5. When those 625 people refer the 5 people each, you'll earn #164 in 3125 places and that's #512,500 + 1 New LG plasma TV.<br>
                            
                            6. When those 3125 people refer the 5 people each, you'll earn #165 in 15625 places and that's #2,578,125 + A trip to Dubai<br>
                        </p>
                        <p style="color:red;">
